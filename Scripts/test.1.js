...
function makeItHtml(){ // This one generates the form boxes - at some point I'd like to be able to account for multiple copies of an element //
    ...
    n = (gettags.length);
        ...
        for (i=0; i <= (n-1); i++){
            ...
            if (list1 === "heading") {
                ...
                const header2 = '" width="680" height="" alt="alt_text" border="0" style="width: 100%; max-width: 680px; height: auto; background: #dddddd; font-family: sans-serif; font-size: 15px; line-height: 15px; color: #555555; margin: auto;" class="fluid g-img">\r</td>\r</tr>\r<!-- Hero Image, Flush : END -->';
...
// If you want to replace the BG color, search and replace #f84d00
// If you want to change the color of the bottom section, search and replace #CB00FF
// I might add those things as customization options, but not for a while yet.
